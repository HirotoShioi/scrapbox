...
module Data.Scrapbox.Example.Example1
  ( getStartedScrapbox,
    getsInterestingSB,
    onceStartedSB,
    getStartedSB,
...
clickRelated =
  p
    [ span
        []
        [ text
            "Click related thumbnails in the footer of any page to explore ideas \
            \you have linked."
        ]
    ]
  ...
  bulletPoint
    ...
    [ p
        [ span
            []
            [ text
                "Pages that are directly linked or two steps away from the current page \
                \will be displayed."
            ]
        ]
    ]
...
ourGoalIs = blockQuote [span [] [ourGoalItext]]
  where
    ourGoalItext =
      text
        " Our goal is to help you build a map of your ideas that gains\
  ...
  where
    letsSayText =
      span
        []
        [ text
            "Lets say you are working on developing a new website. \
    ...
    toStart =
      span
        []
        [ text
            " to start a conversation about the site requirements and link \
  ...
  where
    youcan =
      span
        []
        [ text
            "You can immediately click on that link to `Social media buttons` and \
...
onceYoucan =
  p
    [ span
        []
        [ text
            "Once you can easily and directly type your ideas while also building \
...
whatIdeas =
  blockQuote
    [ span
        [italic]
        [ text
            "What ideas in your head could your team \
...
onceYouGot =
  heading
    2
    [ text
        "📌 Once you've got the basics, here are ways to dig deeper and \
...
pleaseLet =
  ...
  where
    pleaseLetText =
      text
        "Please let us know if you have any suggestions, questions, or \
...
noteWhen = blockQuote [span [] [noteWhenText]]
  where
    noteWhenText =
      text
        "Note: When you're done reading you might change the title of \
